...
public class Orders {
    ...
    public Orders(Integer order_id, Integer user_id, Integer reserve_id, Integer chief_id, Double subtotal, Double gst, Double total_amt, Date order_date, String order_status) {
